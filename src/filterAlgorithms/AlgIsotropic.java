...
/**
 * 
 * @see filterObjects.IsotropicVertical
 * @see filterObjects.IsotropicHorizontall
 */
public class AlgIsotropic implements IAlgorithm {
	...
	public void computeImage(PGMImage image, String name, String[] args) {
		...
		double[] module = FilterMaths.getModule(horImage, verImage,
				image.getWidth(), image.getHeight());
		double[] phase = FilterMaths.getPhase(horImage, verImage,
				image.getWidth(), image.getHeight());

		PGMImage imgModule = new PGMImage(image.getWidth(), image.getHeight(),
				image.getMax_val());
		PGMImage imgPhase = new PGMImage(image.getWidth(), image.getHeight(),
				image.getMax_val());
		...
		PGMUtilities.writePGM(imgModule, PGMUtilities.standardOutputPath + name
				+ "_Sobelmodule.pgm");
		PGMUtilities.writePGM(imgPhase, PGMUtilities.standardOutputPath + name
				+ "_Sobelphase.pgm");
